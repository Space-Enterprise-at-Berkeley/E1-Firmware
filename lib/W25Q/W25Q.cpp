/*
  W25Q.cpp - Arduino library for communicating with the Winbond W25Q Serial Flash.
 ...
 *										Arduino to select W25Q.
 * 
 * 
 *	Purpose :	Initializes the W25Q by setting the input slave select pin
 ...
 * 
 * 
 *	Purpose :	Reads a byte from the flash page and page address.  The W25Q has
 ...
 * 
 *	Purpose :	Writes a byte to the flash page and page address.  The W25Q has
 *				8192 pages with 256 bytes in a page.  Both page and byte addresses
 *				start at 0. Page ends at address 8191 and page address ends at 255.
 * 					
 * 
 ...
 * 
 *	Purpose :	Writes a byte to the W25Q.  Must be first called after 
 ...
 *	Parameters :	None					
 * 
 *	Purpose :	Reads a byte from the W25Q.  Must be first called after 
 ...
 *	Parameters :	None
 * 
 *	Purpose :	Reads the manufacturer ID from the W25Q.  Should return 0xEF.
 * 					
 * 
 ******************************************************************************/
 ...
 *				W25Q is 1 if the chip is busy with a write/erase operation. 
 * 					
 * 
 ******************************************************************************/
void W25Q::notBusy() {
